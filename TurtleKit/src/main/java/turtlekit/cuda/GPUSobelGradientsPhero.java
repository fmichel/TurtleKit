...
//	sobel = getCudaKernel("SOBEL", "/turtlekit/cuda/kernels/SobelGradient_2D.cu", getKernelConfiguration());
	...
	public void diffusionAndEvaporationUpdateKernel() {
		sobel2.run(getWidthPointer(), getHeightPointer(), getValues().getPointer(), tmpDeviceDataGridPtr,
				getPointerToFloat(getEvaporationCoefficient()), cudaIntBuffer.getDataPpointer());
	}
